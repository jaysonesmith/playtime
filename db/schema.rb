...
ActiveRecord::Schema.define(version: 20_170_908_012_526) do
  ...
  create_table 'pledges', force: :cascade do |t|
    ...
    t.index %w[user_id wishlist_item_id], name: 'index_pledges_on_user_id_and_wishlist_item_id', unique: true
